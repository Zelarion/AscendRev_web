 ...
 *
 * Client revision, 2026-09-24: the paragraph that used to sit under the
 * heading ("AscendRev is a new company, so the first hires set the
 * standard...") is deleted, not replaced, per the client's instruction. What
    ...
    <Section>
      <Container>
        ...
        <div className="mt-14">
          ...
          <Stagger className="mt-8 grid gap-x-12 sm:grid-cols-2">
