  ...
  leadership: {
    ...
    facts: [
      {
        ...
        value: 'Over CAD1B across his career.',
      },
      {
    ...
    commercialStats: [
      ...
      },
      {
        ...
        description: 'Enterprise recognition for revenue contribution.',
      },
      {
        icon: '▤',
